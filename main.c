...
//splitting line 
int spl_line(char *temp[],char line[]){
...
if (pid_ret ==0 ){
  ...
  //in child_pid
  //function treplace stdin and put my file reference and return pointer to my file (0)
  if (RI_flag == 1 && F_INPUT != NULL)
  dup2(open(F_INPUT,O_RDWR|O_CREAT,0777), 0);
  //function treplace stdout and put my file reference and return pointer to my file (0)
  ...
  //it is a function which give the dierection of my program and return output and close it 
  execvp(arg[0], arg);
